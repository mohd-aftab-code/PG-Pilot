...
const { uploadComplaintPhoto } = require('../middleware/upload');
...
router.post('/', authenticateToken, uploadComplaintPhoto.single('photo'), complaintController.createComplaint);
router.put('/:id', authenticateToken, uploadComplaintPhoto.single('photo'), complaintController.updateComplaint);
